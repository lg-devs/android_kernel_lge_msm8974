...
sed -i 's/# CONFIG_SND_SOC_APQ8074 is not set/CONFIG_SND_SOC_APQ8074=y/g' ../cyanogenmod_ls980_defconfig
...
sed -i 's/# CONFIG_LGE_NFC_SET_IRQ_WAKEUP is not set is not set/CONFIG_LGE_NFC_SET_IRQ_WAKEUP=y/g' ../cyanogenmod_ls980_defconfig
...
sed -i 's/CONFIG_USB_G_LGE_MULTIPLE_CONFIGURATION=y/# CONFIG_USB_G_LGE_MULTIPLE_CONFIGURATION is not set/g' ../cyanogenmod_ls980_defconfig
sed -i 's/CONFIG_USB_G_LGE_MULTICONFIG_ATF_WA=y/# CONFIG_USB_G_LGE_MULTICONFIG_ATF_WA is not set/g' ../cyanogenmod_ls980_defconfig
...
sed -i 's/# CONFIG_LGE_HEADSET_INSERT_ADDITIONAL_DELAY is not set/CONFIG_LGE_HEADSET_INSERT_ADDITIONAL_DELAY=y/g' ../cyanogenmod_ls980_defconfig
